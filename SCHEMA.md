...
**Статус: реализовано.** Схема действует, перенос выполнен, интерфейс переведён.

Проверено на живых данных: перенесено 8 позиций номенклатуры, 10 мест хранения,
8 строк остатков, 18 событий журнала, 4 документа, 2 конфигурации. Остатки
совпали с прежними до единицы, `integrity_check = ok`, расхождений остатков с
журналом нет.
